...
$output.requireStatic("org.springframework.beans.factory.config.BeanDefinition.SCOPE_PROTOTYPE")##
$output.dynamicAnnotationTakeOver("javax.inject.Named", "org.springframework.context.annotation.Scope(SCOPE_PROTOTYPE)")##
#end
