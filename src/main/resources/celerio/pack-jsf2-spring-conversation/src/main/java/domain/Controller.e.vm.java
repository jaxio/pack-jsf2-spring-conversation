...
public class $output.currentClass extends GenericController<$entity.model.type, $entity.root.primaryKey.type> {
    ...
    @Inject
    public ${output.currentClass}($entity.repository.type $entity.repository.var, $entity.webPermission.type $entity.webPermission.var, $entity.printer.type $entity.printer.var) {
        super($entity.repository.var, $entity.webPermission.var, $entity.printer.var, ${entity.model.type.toUpperCase()}_SELECT_URI, ${entity.model.type.toUpperCase()}_EDIT_URI);
    }    
